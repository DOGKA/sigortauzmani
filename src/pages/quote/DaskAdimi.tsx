 ...
 *
 * `PolicemYok` ayrımı dokümandaki iki örneğe karşılık geliyor: mevcut poliçe
 * varsa yenileme yalnızca poliçe numarasıyla çalışıyor (bina bilgilerini IO
 * poliçeden okuyor), yoksa yeni akış adres ve bina bilgilerini istiyor.
 */
      ...
      {!durum.policemYok ? (
        <label className="flow__field flow__field--full">
          ...
          <span className="flow__hint">
            Yenilemede bina bilgileri poliçenizden okunur, tekrar girmeniz
            gerekmez.
          </span>
            ...
            <>
              <AdresSecici
                onSecim={(adresKodu, ozet) =>
                  onDegis({ adresKodu, adresOzeti: ozet })
                }
              />
              {durum.adresOzeti ? (
          ...
          <div className="flow__grid">
            ...
            <label className="flow__field">
              ...
              <select
                ...
                onChange={(event) =>
                  onDegis({ toplamKatSayisi: event.target.value })
                }
              >
                <option value="">Seçin</option>
            ...
            <label className="flow__field">
              ...
              <select
                ...
                onChange={(event) =>
                  onDegis({ binadakiKonumu: event.target.value })
                }
              >
                <option value="">Seçin</option>
            ...
            <label className="flow__field">
              ...
              <select
                ...
                onChange={(event) =>
                  onDegis({ kullanimSekli: event.target.value })
                }
              >
                <option value="">Seçin</option>
            ...
            <label className="flow__field">
              ...
              <select
                ...
                onChange={(event) =>
                  onDegis({ binaHasarDurumu: event.target.value })
                }
              >
                <option value="">Seçin</option>
