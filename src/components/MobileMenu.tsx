    ...
    >
      ...
      <div className="mobile-menu__panel">
        ...
        <div className="mobile-menu__body">
            ...
            <div className="mobile-menu__quote-inner">
              <ul className="mobile-menu__quote-list">
                {visibleProducts.map((product) => (
                  <li key={product.slug}>
                    <Link to={quoteHref(product.slug)} onClick={onClose}>
                      {product.title}
                      {product.slug === "tamamlayici-saglik" && <em>{t.nav.popular}</em>}
          ...
          <ul className="mobile-menu__links">
            {exploreLinks.map((link, index) => (
              <li key={link.to} style={{ "--i": index + 3 } as React.CSSProperties}>
        ...
        <div className="mobile-menu__foot">
          <a href={`tel:${settings.company.phone}`} className="mobile-menu__call">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              <path
